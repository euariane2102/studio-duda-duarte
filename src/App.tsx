...
export default function App() {
  return (
    <>
      ...
      <a className="whatsapp-float" href="https://wa.me/5541985081825?text=Ol%C3%A1,%20gostaria%20de%20agendar%20um%20hor%C3%A1rio%20com%20a%20Duda." target="_blank" rel="noreferrer" aria-label="Agendar pelo WhatsApp">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M19.11 17.205c-.372 0-1.088 1.39-1.518 1.39a.63.63 0 0 1-.315-.1c-.802-.402-1.504-.817-2.163-1.447-.545-.516-1.146-1.29-1.46-1.963a.426.426 0 0 1-.073-.215c0-.33.99-.945.99-1.49 0-.143-.73-2.09-.832-2.335-.143-.372-.214-.487-.6-.487-.187 0-.36-.043-.53-.043-.302 0-.53.115-.746.315-.688.645-1.032 1.318-1.06 2.264v.114c-.015.99.472 1.977 1.017 2.78 1.23 1.82 2.506 3.41 4.554 4.34.616.287 2.035.888 2.722.888.817 0 2.15-.515 2.478-1.318.142-.34.197-.7.197-1.06 0-.726-.926-1.418-1.66-1.633zm-2.97 7.328a8.395 8.395 0 0 1-4.495-1.297l-3.225.83.86-3.111a8.347 8.347 0 0 1-1.62-4.945c0-4.616 3.762-8.378 8.38-8.378 4.62 0 8.38 3.762 8.38 8.38 0 4.62-3.76 8.38-8.38 8.38m0-18.418c-5.55 0-10.06 4.508-10.06 10.058 0 1.747.453 3.448 1.31 4.954L6.69 27.27l5.34-1.378a10.034 10.034 0 0 0 4.99 1.31c5.55 0 10.06-4.51 10.06-10.06 0-5.55-4.51-10.058-10.06-10.058"/></svg>
      </a>

      <header>
        <a className="logo" href="#inicio">Duda Duarte</a>
      ...
      <main>
        <section className="hero" id="inicio">
          <img className="hero-photo" src="/assets/perfil-duda.jpg" alt="Duda Duarte, especialista em extensão de cílios" />
          <div className="container hero-content">
            <span className="eyebrow">Studio Duda Duarte</span>
            <h1>Extensão de cílios com técnica, agilidade e acabamento premium.</h1>
            <p className="hero-copy">Atendimento em Almirante Tamandaré para mulheres que querem realçar o olhar com naturalidade, segurança e um resultado pensado para a rotina real.</p>
            <div className="hero-actions">
              <a className="btn gold" href="https://wa.me/5541985081825?text=Ol%C3%A1,%20gostaria%20de%20agendar%20um%20hor%C3%A1rio%20com%20a%20Duda." target="_blank" rel="noreferrer">Agendar horário</a>
              <a className="btn light" href="#curso">Conhecer cursos</a>
            </div>
          </div>
        </section>

        <div className="trust-row" aria-label="Diferenciais do studio">
          <div className="trust-item"><strong>4 anos</strong><span>de experiência</span></div>
          <div className="trust-item"><strong>1 hora</strong><span>procedimento otimizado</span></div>
          <div className="trust-item"><strong>30 a 45 dias</strong><span>linha capping</span></div>
          <div className="trust-item"><strong>Pós-curso</strong><span>assistência para alunas</span></div>
        </div>
        ...
        <section className="about" id="sobre">
          <div className="container about-grid">
            ...
            <div>
              <span className="eyebrow">A especialista</span>
              ...
              <div className="about-copy">
                ...
                <p className="signature">Seja bem-vinda ao Studio Duda Duarte.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="services" id="servicos">
          <div className="container">
            <span className="eyebrow">Menu de atendimentos</span>
            <h2>Design para diferentes estilos de olhar.</h2>
            <p className="section-intro">Técnicas indicadas conforme o resultado desejado, a estrutura dos seus fios naturais e a sua rotina de manutenção.</p>

            <div className="menu-grid">
              <article className="menu-card">
                <div className="menu-head"><h3>Volume Clássico Natural</h3><div className="price">R$ 150</div></div>
                <p>Aplicação de um fio sintético em cada fio natural para um efeito delicado, definido e sofisticado.</p>
                <div className="mini-prices"><span>Aplicação R$ 150</span><span>Manutenção R$ 110</span></div>
              </article>
              <article className="menu-card">
                <div className="menu-head"><h3>Volume Brasileiro</h3><div className="price">R$ 160</div></div>
                <p>Técnica com fios em formato Y para criar um olhar mais preenchido, leve e harmônico.</p>
                <div className="mini-prices"><span>Aplicação R$ 160</span><span>Manutenção R$ 110</span></div>
              </article>
              <article className="menu-card">
                <div className="menu-head"><h3>Volume Fox</h3><div className="price">R$ 170</div></div>
                <p>Mapeamento com fios mais longos no canto externo para um olhar alongado, moderno e marcante.</p>
                <div className="mini-prices"><span>Aplicação R$ 170</span><span>Manutenção R$ 120</span></div>
              </article>
              <article className="menu-card featured">
                <div className="menu-head"><h3>Capping 5D</h3><div className="price">R$ 220</div></div>
                <p>Técnica avançada para volume intenso, acabamento uniforme e boa durabilidade, mantendo leveza nos fios naturais.</p>
                <div className="mini-prices"><span>Durabilidade 30 a 45 dias</span><span>Sem manutenção</span></div>
              </article>
              <article className="menu-card featured">
                <div className="menu-head"><h3>Capping Volume Brasileiro</h3><div className="price">R$ 210</div></div>
        ...
        <section className="course" id="curso">
          <div className="container">
            <span className="eyebrow">Formação profissional</span>
            <h2>Curso completo de extensão de cílios.</h2>
            <p className="section-intro">Para quem quer começar do zero, aprender uma técnica ágil e construir uma base profissional para atender com segurança, organização e posicionamento.</p>

            <div className="course-grid">
              <aside className="course-panel">
                <span className="eyebrow">Método Duda Duarte</span>
                ...
                <div className="course-note">Potencial de faturamento depende de prática, agenda, divulgação, região e consistência. A formação entrega método e direcionamento para você construir esse caminho com mais clareza.</div>
              </aside>

              <div>
                <div className="benefit-grid">
                  <div className="benefit"><strong>Do zero ao atendimento</strong><span>Conteúdo pensado para iniciantes que querem começar com base correta.</span></div>
                  <div className="benefit"><strong>Técnicas em 1 dia</strong><span>Imersão objetiva com prática, demonstração e direcionamento.</span></div>
                  <div className="benefit"><strong>Procedimento em 1 hora</strong><span>Método para ganhar agilidade sem perder organização e acabamento.</span></div>
                  <div className="benefit"><strong>Mapeamentos e curvaturas</strong><span>Escolha de fios, efeitos e adaptações para diferentes tipos de olhar.</span></div>
                  <div className="benefit"><strong>Isolamento e retenção</strong><span>Fundamentos para aplicação limpa, durabilidade e preservação dos fios naturais.</span></div>
                  <div className="benefit"><strong>Precificação e captação</strong><span>Orientação para valorizar seu serviço e atrair clientes com mais segurança.</span></div>
                  <div className="benefit"><strong>Apostila e certificado</strong><span>Material completo de apoio e certificado de conclusão.</span></div>
                  <div className="benefit"><strong>Assistência pós-curso</strong><span>Acompanhamento para dúvidas e apoio nos primeiros passos.</span></div>
                </div>

                <div className="premium">
                  <span className="eyebrow">Opção premium</span>
        ...
        <section className="testimonials" id="avaliacoes">
          <div className="container">
            ...
            <div className="testimonial-grid">
              <article className="testimonial-card"><span className="rating">5 estrelas</span><p>"Faço cílios com a Duda há anos. Adoro o trabalho dela, principalmente por sair pronta em cerca de 1 hora com um resultado lindo."</p><strong>Tatty Cruz</strong></article>
              <article className="testimonial-card"><span className="rating">5 estrelas</span><p>"Atendimento incrível, profissional atenciosa e com um trabalho delicado. Deixa meu olhar lindo há mais de 3 anos."</p><strong>Mathyele Candido</strong></article>
              <article className="testimonial-card"><span className="rating">5 estrelas</span><p>"Meus cílios duram de 20 a 30 dias com facilidade. Amo o trabalho e indico pela qualidade e pelo cuidado."</p><strong>Vitoria Talissa</strong></article>
              <article className="testimonial-card"><span className="rating">5 estrelas</span><p>"Cheguei com medo por experiências anteriores, mas a Duda me fez pensar diferente desde o primeiro atendimento."</p><strong>Elisangela França</strong></article>
            </div>
          </div>
        </section>
        ...
        <section className="location" id="local">
          <div className="location-content">
            <span className="eyebrow">Novo espaço</span>
            ...
            <div className="location-actions">
              <a className="btn gold" href="https://wa.me/5541985081825?text=Ol%C3%A1,%20gostaria%20de%20agendar%20um%20hor%C3%A1rio." target="_blank" rel="noreferrer">Agendar pelo WhatsApp</a>
              <a className="btn light" href="https://instagram.com/studiodudaduartec" target="_blank" rel="noreferrer">Ver Instagram</a>
            </div>
          </div>
